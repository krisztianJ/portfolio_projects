...
/*Ez az osztály örökli a FXMLVeradoSceneController osztályt, így elérhetőek benne az ottani metódusok.*/
class FXMLStudentsSceneControllerTest extends FXMLVeradoSceneController {

    /*Teszteli, hogy CheckIfConChar("alma") visszatér-e true-val (mivel van benne betű, ez helyes).*/
    @Test
    ...
    /*Idő formátum / intervallum tesztek*/
    @Test
    ...
    /*getter/setter működnek-e (getHelyszin(), getNev(), getIdo())
getJuttatas() boolean visszatérési értéke rendben van-e
típusellenőrzések (pl. getHelyszin().getClass().equals(String.class))*/
    ...
    /*Ellenőrzi, hogy ha a VPUpdateTableView() metódus fut és kivételt dob, akkor azt ténylegesen megkapjuk.*/
    @Test
